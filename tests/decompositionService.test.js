...
describe("decompositionService", () => {
  test("decomposes sales by client correctly", () => {
    const result = decomposeTransactions("income", "sales", "client");
  ...
  test("decomposes expenses by category correctly", () => {
    const result = decomposeTransactions("expense", null, "category");
  ...
  test("detects concentration correctly", () => {
  ...
  test("handles empty results gracefully", () => {
    const result = decomposeTransactions("income", "non-existent-category");
